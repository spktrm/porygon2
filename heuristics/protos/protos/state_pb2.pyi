...
class State(_message.Message):
    __slots__ = ("info", "legal_actions", "history", "moveset", "public_team", "private_team", "key", "current_context")
    ...
    def __init__(self, info: _Optional[_Union[Info, _Mapping]] = ..., legal_actions: _Optional[bytes] = ..., history: _Optional[_Union[_history_pb2.History, _Mapping]] = ..., moveset: _Optional[bytes] = ..., public_team: _Optional[bytes] = ..., private_team: _Optional[bytes] = ..., key: _Optional[str] = ..., current_context: _Optional[bytes] = ...) -> None: ...
