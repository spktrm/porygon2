 ...
 */
static createPokemon(builder:flatbuffers.Builder, species: number, item: number, item_effect: number, ability: number, gender: number, active: boolean, fainted: boolean, hp: number, maxhp: number, hp_ratio: number, status: number, has_status: boolean, toxic_turns: number, sleep_turns: number, trapped: boolean, newly_switched: boolean, level: number, num_moves: number, is_public: boolean, last_move: number, move_id0: number, move_id1: number, move_id2: number, move_id3: number, move_pp0: number, move_pp1: number, move_pp2: number, move_pp3: number):flatbuffers.Offset {
  builder.prep(2, 40);
 ...
 * @returns PokemonList
 */
static getRootAsPokemonList(bb:flatbuffers.ByteBuffer, obj?:PokemonList):PokemonList {
  return (obj || new PokemonList()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @returns PokemonList
 */
static getSizePrefixedRootAsPokemonList(bb:flatbuffers.ByteBuffer, obj?:PokemonList):PokemonList {
 ...
 */
pokemon(index: number, obj?:features.Pokemon):features.Pokemon|null {
 ...
 */
static addPokemon(builder:flatbuffers.Builder, pokemonOffset:flatbuffers.Offset) {
 ...
 */
static startPokemonVector(builder:flatbuffers.Builder, numElems:number) {
 ...
 * @returns flatbuffers.Offset
 */
static endPokemonList(builder:flatbuffers.Builder):flatbuffers.Offset {
 ...
 */
static finishPokemonListBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
 ...
 * @param flatbuffers.Offset offset
 */
static finishSizePrefixedPokemonListBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, undefined, true);
};

static createPokemonList(builder:flatbuffers.Builder, pokemonOffset:flatbuffers.Offset):flatbuffers.Offset {
