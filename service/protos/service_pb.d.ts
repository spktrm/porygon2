...
export interface ActionEnumMap {
  ...
  ACTION_ENUM__RESERVE_2_SWITCH_IN: 24;
  ACTION_ENUM__RESERVE_3_SWITCH_IN: 25;
  ACTION_ENUM__RESERVE_4_SWITCH_IN: 26;
...
export interface MoveContextEnumMap {
...
export const MoveContextEnum: MoveContextEnumMap;
