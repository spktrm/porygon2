...
class ContextFeature(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    CONTEXT_FEATURE___UNSPECIFIED: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__WEATHER_ID: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__WEATHER_MIN_DURATION: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__WEATHER_MAX_DURATION: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__TERRAIN_ID: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__TERRAIN_MIN_DURATION: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__TERRAIN_MAX_DURATION: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__PSEUDOWEATHER_ID: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__PSEUDOWEATHER_MIN_DURATION: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__PSEUDOWEATHER_MAX_DURATION: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__MY_SIDECONDITIONS0: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__MY_SIDECONDITIONS1: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__MY_TOXIC_SPIKES: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__MY_SPIKES: _ClassVar[ContextFeature]
    CONTEXT_FEATURE__OPP_SIDECONDITIONS0: _ClassVar[ContextFeature]
...
CONTEXT_FEATURE___UNSPECIFIED: ContextFeature
CONTEXT_FEATURE__WEATHER_ID: ContextFeature
CONTEXT_FEATURE__WEATHER_MIN_DURATION: ContextFeature
CONTEXT_FEATURE__WEATHER_MAX_DURATION: ContextFeature
CONTEXT_FEATURE__TERRAIN_ID: ContextFeature
CONTEXT_FEATURE__TERRAIN_MIN_DURATION: ContextFeature
CONTEXT_FEATURE__TERRAIN_MAX_DURATION: ContextFeature
CONTEXT_FEATURE__PSEUDOWEATHER_ID: ContextFeature
CONTEXT_FEATURE__PSEUDOWEATHER_MIN_DURATION: ContextFeature
CONTEXT_FEATURE__PSEUDOWEATHER_MAX_DURATION: ContextFeature
CONTEXT_FEATURE__MY_SIDECONDITIONS0: ContextFeature
CONTEXT_FEATURE__MY_SIDECONDITIONS1: ContextFeature
CONTEXT_FEATURE__MY_TOXIC_SPIKES: ContextFeature
CONTEXT_FEATURE__MY_SPIKES: ContextFeature
CONTEXT_FEATURE__OPP_SIDECONDITIONS0: ContextFeature
