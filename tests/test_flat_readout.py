...
def _rows(key: jax.Array) -> tuple[jax.Array, jax.Array, jax.Array]:
...
def _init() -> tuple[FlatActionReadout, dict, tuple[jax.Array, jax.Array, jax.Array]]:
    head = _readout()
