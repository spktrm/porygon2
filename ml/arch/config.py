...
def get_model_cfg():
    ...
    cfg.encoder.timestep_encoder.resblocks_hidden_size = transformer_hidden_size
    cfg.encoder.timestep_encoder.x_need_pos = True
    ...
    entity_projection_num_heads = 4
    cfg.encoder.entity_projection.num_heads = entity_projection_num_heads
    cfg.encoder.entity_projection.embed_dim = entity_size // entity_projection_num_heads
    ...
    cfg.value_head.logits.num_logits = 18
