...
proto.history.HistoryStep.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    hyphenargs: (f = msg.getHyphenargs()) && messages_pb.HyphenargsMessage.toObject(includeInstance, f)
  };
...
proto.history.HistoryStep.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new messages_pb.HyphenargsMessage;
      reader.readMessage(value,messages_pb.HyphenargsMessage.deserializeBinaryFromReader);
...
proto.history.HistoryStep.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getHyphenargs();
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      messages_pb.HyphenargsMessage.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional messages.HyphenargsMessage hyphenArgs = 7;
 * @return {?proto.messages.HyphenargsMessage}
 */
proto.history.HistoryStep.prototype.getHyphenargs = function() {
  return /** @type{?proto.messages.HyphenargsMessage} */ (
    jspb.Message.getWrapperField(this, messages_pb.HyphenargsMessage, 7));
};


/**
 * @param {?proto.messages.HyphenargsMessage|undefined} value
 * @return {!proto.history.HistoryStep} returns this
*/
proto.history.HistoryStep.prototype.setHyphenargs = function(value) {
 ...
 * @return {!proto.history.HistoryStep} returns this
 */
proto.history.HistoryStep.prototype.clearHyphenargs = function() {
  return this.setHyphenargs(undefined);
};
 ...
 * @return {boolean}
 */
proto.history.HistoryStep.prototype.hasHyphenargs = function() {
