...
proto.history.HistoryStep.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pseudoweather: (f = msg.getPseudoweather()) && messages_pb.PseudoweatherMessage.toObject(includeInstance, f),
...
/**
 * optional messages.PseudoweatherMessage pseudoweather = 4;
...
proto.history.HistoryStep.prototype.getPseudoweather = function() {
  return /** @type{?proto.messages.PseudoweatherMessage} */ (
    jspb.Message.getWrapperField(this, messages_pb.PseudoweatherMessage, 4));
};
