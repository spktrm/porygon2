    ...
    return (
        BuilderActorInput(
            env=BuilderEnvOutput(
                ...
                species_prob=np.zeros_like(done, dtype=np.float32),
                ev_reward=np.zeros_like(done, dtype=np.float32),
                teammate_prob=np.zeros_like(done, dtype=np.float32),
                item_prob=np.zeros_like(done, dtype=np.float32),
                ability_prob=np.zeros_like(done, dtype=np.float32),
                move_prob=np.zeros_like(done, dtype=np.float32),
                teratype_prob=np.zeros_like(done, dtype=np.float32),
                nature_prob=np.zeros_like(done, dtype=np.float32),
            ),
